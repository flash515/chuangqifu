...
Page({
    ...
    bvLinkShow(e) {
        ...
        console.log(app.globalData.Guserdata.TradeInfo.PromoteLevel)
        if (app.globalData.Guserdata.TradeInfo.PromoteLevel == "normal" || app.globalData.Guserdata.TradeInfo.PromoteLevel == "member" || app.globalData.Guserdata.TradeInfo.PromoteLevel == undefined) {
            utils._ErrorToast("需白银会员权限")
        } else {
            this.setData({
